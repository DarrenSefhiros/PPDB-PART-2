...
const Sidnav = () => {
  ...
  return (
    <div className="fixed top-0 left-0 h-full w-60 bg-gradient-to-b from-pink-500 via-pink-600 to-pink-800 text-white shadow-2xl flex flex-col">
      ...
      {/* WRAPPER MENU (SCROLL AREA) */}
      <div className="p-6 border-b border-pink-400 flex-1 overflow-y-auto">
        ...
        <ul className="space-y-5">
          ...
          <li>
            <a
              href="/Presensi"
              className="flex items-center text-nowrap gap-3 text-lg hover:bg-pink-800 w-auto rounded-md px-3 transition-all duration-200"
            >
